...
Estos términos y condiciones describen las reglas y regulaciones para el uso del sitio web de Hebra Circular, ubicado en www.hebracircular.com.

Al acceder a este sitio web, asumimos que aceptas estos términos y condiciones. No continúes usando Hebra Circular si no estás de acuerdo con todos los términos y condiciones establecidos en esta página.

**Cookies:**

El sitio web utiliza cookies para ayudar a personalizar tu experiencia en línea. Al acceder a Hebra Circular, aceptaste utilizar las cookies necesarias.
...
A menos que se indique lo contrario, Hebra Circular poseen los derechos de propiedad intelectual de todo el material en Hebra Circular. Todos los derechos de propiedad intelectual son reservados. Puedes acceder desde Hebra Circular para tu uso personal sujeto a las restricciones establecidas en estos términos y condiciones.

No debes:

- Copiar o volver a publicar material de Hebra Circular
- Vender, alquilar o sublicenciar material de Hebra Circular
- Reproducir, duplicar o copiar material de Hebra Circular
- Redistribuir contenido de Hebra Circular

Este acuerdo comenzará en la fecha presente.

Partes de este sitio web ofrecen a los usuarios la oportunidad de publicar e intercambiar opiniones e información en determinadas áreas. Hebra Circular no filtra, edita, publica ni revisa los comentarios antes de su presencia en el sitio web. Los comentarios no reflejan los puntos de vista ni las opiniones de Hebra Circular, sus agentes y/o afiliados. Los comentarios reflejan los puntos de vista y opiniones de la persona que publica. En la medida en que lo permitan las leyes aplicables, Hebra Circular no será responsable de los comentarios ni de ninguna responsabilidad, daños o gastos causados o sufridos como resultado de cualquier uso o publicación o apariencia de comentarios en este sitio web.

Hebra Circular se reserva el derecho de monitorear todos los comentarios y eliminar los que puedan considerarse inapropiados, ofensivos o que incumplan estos Términos y Condiciones.
...
Por la presente, otorgas a Hebra Circular una licencia no exclusiva para usar, reproducir, editar y autorizar a otros a usar, reproducir y editar cualquiera de tus comentarios en todas y cada una de las formas, formatos, o medios.
</Typography>
<Typography variant="h6">
...
Estas organizaciones pueden enlazar a nuestra página de inicio, a publicaciones o a otra información del sitio siempre que el enlace:

- (a) no sea engañoso de ninguna manera;
- (b) no implique falsamente patrocinio, respaldo o aprobación de la parte vinculante y sus productos y/o servicios; y
...
- (a) el enlace no nos haría vernos desfavorablemente a nosotros mismos ni a nuestras empresas acreditadas;
- (b) la organización no tiene registros negativos con nosotros;
- (c) el beneficio para nosotros de la visibilidad del hipervínculo compensa la ausencia de Hebra Circular; y
- (d) el enlace está en el contexto de información general de recursos.

Estas organizaciones pueden enlazar a nuestra página de inicio siempre que el enlace:

- (a) no sea engañoso de ninguna manera;
- (b) no implique falsamente patrocinio, respaldo o aprobación de la parte vinculante y sus productos o servicios; y
- (c) encaja en el contexto del sitio de la parte vinculante.

Si eres una de las organizaciones enumeradas en el párrafo 2 y estás interesada en vincularte a nuestro sitio web, debes informarnos enviando un correo electrónico a

 Hebra Circular. Incluye tu nombre, el nombre de tu organización, la información de contacto, así como la URL de tu sitio, una lista de las URL desde las que tienes la intención de vincular a nuestro sitio web y una lista de las URL de nuestro sitio a las que te gustaría acceder. Espera 2-3 semanas para recibir una respuesta.
...
No se permitirá el uso del logotipo de Hebra Circular u otro material gráfico para vincular sin un acuerdo de licencia de marca comercial.
</Typography>
<Typography variant="h6">
...
Las limitaciones y prohibiciones de responsabilidad establecidas en esta sección y en otras partes de este descargo de responsabilidad:

- Están sujetas al párrafo anterior; y
- Regirán todas las responsabilidades que surjan en virtud de la exención de responsabilidad, incluidas las responsabilidades que surjan en el contrato, en agravio y por incumplimiento de la obligación legal.
