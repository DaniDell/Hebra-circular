      ...
      <CardContent sx={{ marginBottom: '0px' }}>
        ...
        >
          {Math.abs(dataCarbon[0].mitiga) < 0.0001
            ? "Descubrí el valor de gestionar tus remanetes"
            : `Mitiga ${formatNumber(carbonReductionPercentage)}% de ☁ CO₂* respecto a su fin de vida en un vertedero mediante gestión y reciclaje ♻️:`}
        </Typography>
        ...
        <Box display="flex" justifyContent="center">
          <Box>
            ...
            paddingRight: '3rem',
                ...
                >{`💧 Evita el uso de ${formatNumber(waterMitigated)} Lts.  = ${Math.floor(waterMitigated / 900)} años de consumo humano`}</Typography>
                 <Typography
                  variant="body2"
                  sx={{
                    fontSize: '1 rem',
